...
columns:
  ...
  Pronouns:
    ...
    options:
      ...
      - { label: "They/Them", value: "They/Them", color: "hsl(239, 95%, 90%)"}
    config:
      enable_media_view: true
      link_alias_enabled: true
      media_width: 100
  ...
  Frame:
    ...
    sortIndex: -1
    options:
      - { label: "Vlad", value: "Vlad", color: "hsl(26, 95%, 90%)"}
      - { label: "Chomolungma", value: "Chomolungma", color: "hsl(162, 95%, 90%)"}
      - { label: "Kobold", value: "Kobold", color: "hsl(49, 95%, 90%)"}
